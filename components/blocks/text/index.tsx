...
export const Title = styled(UIText)<IPText>((props) => [
	(props.mode === 'light') && tw`text-white`,
...
export const Text = styled(UIText)<IPText>((props) => [
	(props.mode === 'light') && tw`text-white`,
	props.base && tw`font-default text-[15px] leading-[25px] tracking-[0]`,
	props.overline && tw`text-sm uppercase leading-[19px] tracking-[10px]`,
	props.subtitle && tw`text-xs font-bold uppercase leading-[25px] tracking-[1px]`,
])
